...
<template>
	<div
		@click="toggleMode"
		class="hover:bg-surface-container-highest hover:border hover:border-outline/70 border-transparent cursor-pointer rounded-full p-1 w-[32px] h-[32px] flex items-center justify-center"
	>
		<Icon
			v-if="isDarkMode"
			name="line-md:moon-filled-alt-to-sunny-filled-loop-transition"
			class="min-w-[24px] min-h-[24px] text-amber-300"
		/>
		<Icon
			v-else
			name="line-md:sunny-filled-loop-to-moon-filled-loop-transition"
			class="min-w-[24px] min-h-[24px] text-slate-500"
		/>
	</div>
</template>
